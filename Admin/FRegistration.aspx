<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FRegistration.aspx.cs" Inherits="FRegistration" %>
                    ...
                    <fieldset class="fieldset">
                        ...
                        <table>
                            ...
                            <tr id="trmembrid" runat="server" visible="False">
                                <td id="Td1" align="right" class="text" runat="server" style="height: 30px">
                                    Member Id:
                                </td>
                                <td id="Td2" runat="server" style="height: 30px">
                    ...
                    <fieldset class="fieldset">
                        ...
                        <table id="tblmode" width="100%">
                            ...
                            <tr id="trutr" runat="server" visible="true">
                                <td id="Td3" align="right" class="text" style="width: 23%" runat="server">
                                    UTR Number :
                                </td>
