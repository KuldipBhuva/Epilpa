<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EventSms.aspx.cs" Inherits="Admin_EventSms" %>
                                        ...
                                        <td height="10" align="center" valign="top">
                                            <div id="head-mainmenu">
                                                <ul>
                                                    ...
                                                    <li><a class="active" href="Change_Password.aspx"><span>Events SMS </span></a></li>
                                                                        ...
                                                                        <table width="290%" border="0" align="center" cellpadding="3" cellspacing="0" class="border2">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <asp:ImageButton src="images/calendar-2-icon.png" ID="ImageButton3" runat="server"
                                                                                        Height="30" Width="30" OnClick="ImageButton3_Click" />
                                                                                    <asp:Calendar ID="Calendar1" runat="server" Visible="false" OnSelectionChanged="Calendar1_SelectionChanged"
                                                                                        Format="dd mm yyyy" TodaysDateFormat="dd/mm/yyyy"></asp:Calendar>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td align="right">
                                                                                ...
                                                                                <td class="style2">
                                                                                    <asp:DropDownList ID="ddlhour" runat="server" Width="100px">
                                                                                        <asp:ListItem Text="Select Hour">
                                                                                        </asp:ListItem>
                                                                                    </asp:DropDownList>
                                                                                    <asp:DropDownList ID="ddlMin" runat="server" OnSelectedIndexChanged="ddlMin_SelectedIndexChanged"
                                                                                        AutoPostBack="True">
                                                                                        <asp:ListItem Text="Select Minute">
                                                                                        </asp:ListItem>
                                                                                    </asp:DropDownList>
